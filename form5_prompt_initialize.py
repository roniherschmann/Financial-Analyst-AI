...
# initialization script for a Weave prompt to analyze Form 5 filings
# form5_prompt_initialize.py
...
class Form5Prompt(Prompt):
    """
    Custom Prompt for Form 5 Analysis:
    ...
    system_config: Dict[str, Any] = {
        ...
        "subject": "Structured extraction and summarization of {ticker}'s Form 5 for {reporting_year}",
        "persona": "Data-driven equity research associate—detail-oriented, questioning",
        "tone": "Institutional, skeptical, data-supported, and technical",
        "context": "Equity research and insider-monitoring for a hedge fund or asset manager.",
        "knowledge_scope": (
    ...
    workflow: List[Dict[str, str]] = [
        {"step": 1, "description": "Detect 'Form 5' request and parse placeholders {ticker} and {reporting_year} from user prompt."},
        {"step": 2, "description": "Fetch the specified Form 5 PDF/text from SEC EDGAR API for {ticker}, reporting year: {reporting_year}."},
        {"step": 3, "description": "Parse each insider's unreported trades: date, transaction type, security class, quantity, and price."},
        {"step": 4, "description": "Extract insider names and roles; note relationship to company (officer, director, >10% holder)."},
        {"step": 5, "description": "Compute annual aggregate impact: total shares acquired vs. sold per insider; net change in holdings."},
        {"step": 6, "description": "Identify red flags: unusual patterns, late disclosures, or crossing >10% threshold due to Form 5 trades."},
        {"step": 7, "description": "Assemble the structured summary following the 'task' outline. Use bullet points and a summary table."},
        {"step": 8, "description": "Add a concluding question: 'Do you want to review detailed transaction history for any specific insider?'"}
    ]
...
form5_prompt = Form5Prompt()
weave.publish(form5_prompt, name="generic_form5_prompt")
...
if __name__ == "__main__":
    ...
    # Format the prompt for a specific ticker/reporting_year
    messages = form5_prompt.format(
        ticker="AAPL", 
        reporting_year="2023"
    )
